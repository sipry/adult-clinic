...
const translations: Record<Language, Record<string, TranslationValue>> = {
  es: {
    ...
    'provider.bio.dr1': 'El Dr. Jaime A. Acosta, MD, es un médico general altamente capacitado y compasivo, comprometido con brindar atención médica integral a pacientes adultos en Kissimmee, Florida. Con un enfoque en la continuidad del cuidado y la medicina preventiva, ofrece planes de tratamiento personalizados para atender una amplia variedad de condiciones médicas y promover el bienestar general.',
    'provider.bio.dr1.text2': 'En Your Health Adult Care, ofrece una variedad de servicios, incluyendo evaluaciones de salud, manejo de enfermedades agudas y crónicas, y procedimientos quirúrgicos menores. El Dr. Acosta es especialista en medicina general, con licencia para ejercer en Florida, Michigan y Puerto Rico, y está afiliado a la red AdventHealth. Actualmente está aceptando nuevos pacientes.',
    ...
    "peds.badge": "Visita nuestra clínica pediátrica también",
    "peds.heroTitle": "Your Health Pediatrics",
  ...
  en: {
    ...
    "peds.badge": "Visit our pediatric clinic too",
    "peds.heroTitle": "Your Health Pediatrics",
